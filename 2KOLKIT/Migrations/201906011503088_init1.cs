namespace _2KOLKIT.Migrations
{
    ...
    public partial class init1 : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                "dbo.WorkGroupEmployees",
                c => new
                    {
                        WorkGroup_WorkGroupId = c.Int(nullable: false),
                        Employee_EmployeeId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => new { t.WorkGroup_WorkGroupId, t.Employee_EmployeeId })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.WorkGroupEmployees", "Employee_EmployeeId", "dbo.Employees");
            DropForeignKey("dbo.WorkGroupEmployees", "WorkGroup_WorkGroupId", "dbo.WorkGroups");
            DropForeignKey("dbo.Absences", "EmployeeId", "dbo.Employees");
            DropIndex("dbo.WorkGroupEmployees", new[] { "Employee_EmployeeId" });
            DropIndex("dbo.WorkGroupEmployees", new[] { "WorkGroup_WorkGroupId" });
            ...
            DropTable("dbo.WorkGroupEmployees");
